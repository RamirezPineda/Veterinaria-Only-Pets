...
@section('contenido')
    ...
    <div class="row">
        ...
        <div class="col-3">
            <div class="card">
                <div class="card-header bg-active text-white">
                    <h5 class="card-title mb-0 fs-5">Total de Ganancias</h5>
                </div>
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div id="divganancia">
                            <h2 id="textganancia" class="card-subtitle mb-2 text-muted">{{ $ganancias->gananciaVentasMes }}
                                <b>Bs.</b>
                            </h2>

                            <label class="card-text small"> <input type="radio" id="opcion1"
                                    value="{{ $ganancias->gananciaVentasMes }}"> Este mes</label>
                            <label class="card-text small"> <input type="radio" id="opcion2"
                                    value="{{ $ganancias->gananciaVentasAnio }}"> Este año</label>
                            <label class="card-text small"> <input type="radio" id="opcion3"
                                    value="{{ $ganancias->gananciaTodasLasVentas }}"> Total</label>
                        </div>
                        <div class="bg-active text-white rounded-circle p-4">
        ...
        <div class="col-3">
            <div class="card">
                <div class="card-header bg-active text-white">
                    <h5 class="card-title mb-0 fs-5">Clientes Registrados</h5>
                </div>
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="card-subtitle mb-2 text-muted">{{ $cantidadClientes }}</h2>
                            <p class="card-text small">Registros</p>
                        </div>
                        <div class="bg-active text-white rounded-circle p-4">
        ...
        <div class="col-3">
            <div class="card">
                <div class="card-header bg-active text-white">
                    <h5 class="card-title mb-0 fs-5">Mascotas Registradas</h5>
                </div>
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="card-subtitle mb-2 text-muted">{{ $cantidadMascotas }}</h2>
                            <p class="card-text small">Registros</p>
                        </div>
                        <div class="bg-active text-white rounded-circle p-4">
        ...
        <div class="col-3">
            <div class="card">
                <div class="card-header bg-active text-white">
                    <h5 class="card-title mb-0 fs-5">Mascotas Atendidas</h5>
                </div>
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="card-subtitle mb-2 text-muted">{{ $mascotasAtendidasMesActual }}</h2>
                            <p class="card-text small">Este mes</p>
                        </div>
                        <div class="bg-active text-white rounded-circle p-4">
    ...
    <div style="height: 1600">
            ...
            <div class=" col-7 ">
                <div class=" p-0  border-danger border-2  rounded-top">
                    ...
                    <div class="p-1 text-center">
                        ...
                        <button id="btnSemana" class="btn bg-active">semana</button>
                        <button id="btnMes" class="btn bg-active">mes</button>
                        <button id="btnAnio" class="btn bg-active">Año</button>
                    </div>
                    <div id="grafico"></div>
                </div>
            </div>
            ...
            <div class=" col-6 ">
                <div class=" p-0  border-danger border-2 rounded-top">
                    ...
                    <div class="p-1 text-center">
                        ...
                        <button id="botonBarraGrafico3" class="btn bg-active" >barra</button>
                        <button id="botonLineaGrafico3" class="btn bg-active" >linea</button>
                    </div>
                    <div id="grafico3"></div>
                </div>
            </div>
            ...
            <div class=" col-6 ">
                <div class="p-0  border-danger border-2 rounded-top">
                    ...
                    <div class="p-1 text-center">
                        ...
                        <button id="botonBarraGrafico4" class="btn bg-active" >barra</button>
                        <button id="botonLineaGrafico4" class="btn bg-active" >linea</button>
                    </div>
                    <div id="grafico4"></div>
                </div>
            </div>
        ...
        <svg class="sausage-dog-animation" xmlns="http://www.w3.org/2000/svg" viewBox="-50 0 1200 1080">
            <ellipse class="shadow" ry="45" rx="350" cy="816" cx="498" opacity="1" fill="#B2CAE8"
                fill-opacity="1" stroke="#B2CAE8" stroke-width="4" />
            ...
            <g class="lean">
                ...
                <g class="head">
                    ...
                    <g class="eye">
                        <ellipse ry="58.79958" rx="63.385227" cy="337.63333" cx="930.31775" opacity="1" fill="#6f5a4b"
                            fill-opacity="1" stroke="#6f5a4b" stroke-width="7" />
...
<script>
  ...
  new Chart(ctx, {
    ...
    <script src="{{ asset('js/dashboard/grafico2.js') }}"></script>
    <script src="{{ asset('js/dashboard/grafico3.js') }}"></script>
    <script src="{{ asset('js/dashboard/grafico4.js') }}"></script>
